...
<section class="cart pd-section">
    <div class="container">
        <div class="cart__header d-flex space-between align-center">
            ...
            <a class="h4" href="index.php?page=product_category">Quay lại</a>
        </div>
        <?php
        ...
        ?>
            ...
            <div class="cart__footer w-100 h-100">
                <div class="cart__footer--total h4">
                    Liên hệ : <?php echo number_format((float) $total) . '₫' ?>
                </div>
                ...
                ?>
                    ...
                    ?>
                    <a href="index.php?page=login"><button class="btn cart__btn btn__outline">Liên hệ đặt hàng</button></a>
                <?php
                }
                ?>
