                        ...
                        <div class="product-detail__info">
                            <form method="POST" action="pages/handle/addtocart.php?product_id=<?php echo $row_product_detail['product_id'] ?>">
                                ...
                                <?php if ($row_product_detail['product_quantity'] > 0) { ?>
                                    ...
                                    <input class="btn product-detail__buynow w-100" type="submit" name="buynow" value="Liên hệ" />
                                <?php } else { ?>
                                    <a href="https://zalo.me/0909613837" class="btn product-detail__buynow w-100 text-center">Liên hệ</a>
                                <?php } ?>
                                ...
                                <a class="product-detail__anchor" href="#">
                                    <ul class="social__items d-flex align-center">
                                        ...
                                        <li class="social__item opacity-50">
                                            <a class="https://www.facebook.com/" href="#info-product">
                    ...
                    <div class="evaluate__content">
                        ...
                        ?>
                            <div class="comment-item d-flex">
                                <div class="f-cmuser"><abbr title="localhost:8080 Ann"><?php echo substr($evaluate['account_name'], 0, 1) ?></abbr></div>
