<?php
$keyword = ''; // Khởi tạo biến với giá trị mặc định

if (isset($_POST['search'])) {
    $keyword = mysqli_real_escape_string($mysqli, trim($_POST['keyword']));
}
        ...
        <div class="row">
            <div class="col">
                <div class="product__title text-center">
                    ...
                    <p class="h9">Tìm kiếm có liên quan đến "<?php echo htmlspecialchars($keyword) ?>"</p>
                </div>
            </div>
            <?php
            $i = 0;
                        ...
                        <div class="product__info">
                            ...
                            <span class="review-star-list d-flex">
                                ...
                                while ($evaluate_rating = mysqli_fetch_array($query_evaluate_rating)) {
                                    $total_rate++;
                                    $rate_avg += $evaluate_rating['evaluate_rate'];
                                }

                                if ($total_rate > 0) {
                                    $rate_avg = round($rate_avg / $total_rate, 1);
                                }
